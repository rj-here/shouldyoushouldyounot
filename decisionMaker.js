...
var wordsToIgnore = [
    ...
    // Variations for "knife"
    "knife", "kn!fe", "kn1fe", "kn!f3", "kn1f3", "kn!f3!", "kn1f3!", "kn!fe!", "kn1fe!",

    // Variations for "poke"
    "poke", "p0ke", "p0k3", "p0k3!", "p0ke!", "p0k3y", "p0k3y!", "p0key", "p0key!",

    // Variations for "fork"
    "fork", "f0rk", "f0rk!", "f0rk3", "f0rk3!", "f0rky", "f0rky!", "f0rkey", "f0rkey!",

    // Variations for "smack"
    "smack", "sm@ck", "sm4ck", "sm@ck!", "sm4ck!", "sm@ck3", "sm4ck3", "sm@ck3!", "sm4ck3!",

    // Variations for "punch"
    "punch", "pun@h", "pun4h", "pun@h!", "pun4h!", "pun@ch", "pun4ch", "pun@ch!", "pun4ch!",

    // Variations for "hammer"
    "hammer", "h@mm3r", "h4mm3r", "h@mm3r!", "h4mm3r!", "h@mm3r3", "h4mm3r3", "h@mm3r3!", "h4mm3r3!",

    // Variations for "kick"
    "kick", "k!ck", "k1ck", "k!ck!", "k1ck!", "k!ck3", "k1ck3", "k!ck3!", "k1ck3!",

    // Variations for "murder"
    "murder", "murd3r", "murd3r!", "murd3rr", "murd3rr!", "murd3rrr", "murd3rrr!", "murd3r3", "murd3r3!",

    // Variations for "unalive"
    "unalive", "un@live", "un4live", "un@live!", "un4live!", "un@liv3", "un4liv3", "un@liv3!", "un4liv3!"
];
